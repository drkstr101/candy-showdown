...
const button = tv({
  ...
  variants: {
    variant: {
      ...
      secondary:
        'bg-neutral-100 hover:bg-neutral-200 pressed:bg-neutral-300 text-neutral-800 dark:bg-neutral-600 dark:hover:bg-neutral-500 dark:pressed:bg-neutral-400 dark:text-neutral-100',
    ...
    isDisabled: {
      true: 'bg-neutral-100 dark:bg-neutral-800 text-neutral-300 dark:text-neutral-600 forced-colors:text-[neutralText] border-black/5 dark:border-white/5',
    },
  },
  defaultVariants: {
    variant: 'primary',
